...
export default class extends React.Component {
  ...
  render() {
    const matchesSubscription = Meteor.subscribe('secret-santa.matches', Meteor.userId());
    const groupsSubscription = Meteor.subscribe('secret-santa.groups', Meteor.userId());
